...
<script>
    import {getProject,getJobList,newJob,getModelExplain,getPredictResultAndDetail,getPredictHistory} from '../api/api';
    ...
    export default {
        ...
        methods: {
            ...
            drawChart(modelExplain){
                this.modelData={model_name:modelExplain.model_name,
