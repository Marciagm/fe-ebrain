		...
		<div class="uploading">
			<div ref="left" class="uploading-left">
				...
				<div style="margin-bottom: 21px;" >
					<div @click="advancedOption" style="cursor: pointer;">
				...
				<div>
					<div style="text-align: left; padding-left: 2%;">
						<div style="padding-left: 14px;padding-right: 14px;display: inline-block; border: 1px solid #eee; border-bottom: 0px; height: 41px; line-height: 41px;" >
							...
							<span style="color: #333; font-size: 14px;letter-spacing: 1px;">特征详情</span>
							<el-autocomplete
						      v-model="state1"
						...
						<div style="width: 50%;display: inline-block; vertical-align: top; border-bottom: 1px solid #eee; height: 41px; line-height: 41px; padding-left: 45px;">
		...
		methods: {
		    ...
		    loadAll() {
	        	return [
			          ...
			          { "value": "Hot", "address": "上海市长宁区淞虹路661号" },
