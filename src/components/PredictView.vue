        ...
        <div id="uploadView" ref="uploadView">
            ...
            <div class="right">
                <div class="file-list" ref="fileListDiv">
                    ...
                    <div class="content">
                        <div>
                            <el-row v-for="file in predictHistoryList" :key="file.tid"  class="file-item">
                                <el-col :span="24">
                                    <el-row>
                                        <el-col :span="2" style="overflow: hidden">
                                            <i class="el-icon-loading" v-show="runningList[file.filename] || file.status=='running'"></i>
                                        </el-col>
                                        <el-col :span="22" style="overflow: hidden">
                                            <div @click="showResult(file)">{{file.srcFile}}</div>
                                        </el-col>
                ...
                getPredictResultAndDetail(param).then(data=>{
                    ...
                    if (code > 0) {
                        ...
                        if(data.data.result){
                            ...
                            window.clearInterval(window.timer2);
                            that.predictResult = JSON.parse(data.data.result.predictResult).dataList;
                            that.predictDetail = data.data.detail;
                        }
